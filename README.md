...
[![Build Status](https://travis-ci.org/gurix/mongoid-rspec.svg?branch=master)](https://travis-ci.org/gurix/mongoid-rspec)
...
```ruby
  gem 'mongoid-rspec', github: 'gurix/mongoid-rspec'
```
